...
{% include translation-block.html title="Chorus: AP" content=chorus1 %}

{% capture verse1 %}
{% include line.html pa="Kujh kehn nu eh dil kyon na kare mainu" en="Why doesn't my heart let me say something?" %}
{% include line.html pa="Sun de ne dawara picchon longe hi" en="I listen only in passing from behind doors (closed)" %}
{% include line.html pa="Pata na lagge meri zindagi eh ki inna" en="I don't know what my life has become" %}
{% include line.html pa="Sochan de das kinj lai jave o" en="Tell me how I can take away these thoughts" %}
{% include line.html pa="Hun vekhida te ne tare na pata ae aa" en="Now I'm looking at the stars but even they don't know" %}
{% include line.html pa="Velli mere jod sine layi" en="My wounds are stitched onto my chest" %}
{% include line.html pa="Kujh yaadan ne aisiya jo phade aa ae mainu" en="Some memories are such that they've grabbed a hold of me" %}
{% include line.html pa="Khali botalaan ne yaari te mein badiya kasai" en="Empty bottles are my friends and I am an amazing butcherer (destroying himself through drinking)" %}
{% endcapture %}

{% include translation-block.html title="Verse 1: AP" content=verse1 %}
...
{% include translation-block.html title="Chorus: AP and Shinda" content=chorus2 %}

{% capture verse2 %}
{% include line.html pa="Aakh di shaitaaniyan jo maare aa mainu" en="The mischievousness of the eyes are what killed me" %}
{% include line.html pa="Heeriya de sapne te kachdi chamak si" en="The dreams of diamonds were just a shine of glass (trick of the eye)" %}
{% include line.html pa="Meri barbaadi da jo rasta mein phadeya" en="The path of destruction that I have taken" %}
{% include line.html pa="Aun pachtava kade meri li phalak si" en="Now I regret it, was the sky ever for me? (talking about how the highest goals weren't for him)" %}
{% include line.html pa="Muqadara de lekh mitti kade taare khali" en="The writings of fate are erased, and sometimes the stars are empty" %}
{% include line.html pa="Kamre ch nibhadi na meri sunvayi koi" en="Inside the room, there is no hope for anyone to listen" %}
{% include line.html pa="Vekhe mainu te pher chhad gahe sidda loki" en="They see me and then leave me to it" %}
{% include line.html pa="Pyaar de ne vairi mainu lagde chadayi" en="The enemies of love are directly challenging me" %}
{% endcapture %}
